...
import static com.rohankhayech.choona.lib.model.tuning.InstrumentTuning.DEFAULT_INSTRUMENT;
...
/**
 * Test harness for the InstrumentTuning class.
 *
 * @author Rohan Khayech
 */
public final class InstrumentTuningTest {

    private final InstrumentTuning tuning = Tunings.STANDARD;

    @Test
    public void testConstructor() {
        // Check input validation
        assertThrows(NullPointerException.class, ()->new InstrumentTuning(DEFAULT_INSTRUMENT, GuitarString.E2, null)); // Element is null.
        assertThrows(NullPointerException.class, ()->new InstrumentTuning(DEFAULT_INSTRUMENT, (GuitarString[])null)); // Array is null.
        assertThrows(NullPointerException.class, ()->new InstrumentTuning((Instrument)null, GuitarString.E2)); // Instrument is null.
        assertFalse(new InstrumentTuning(null, DEFAULT_INSTRUMENT, InstrumentTuning.Category.COMMON, GuitarString.E2).hasName()); // Name is null.
        assertNull(new InstrumentTuning(null, DEFAULT_INSTRUMENT, null, GuitarString.E2).category); // Category is null.

        // Test copy
        assertEquals(tuning, new InstrumentTuning("Standard", tuning));
        assertEquals("InstrumentTuning", new InstrumentTuning("InstrumentTuning", tuning).getName());
        assertThrows(NullPointerException.class, ()->new InstrumentTuning("Name", null)); // Other is null
    }
    ...
    public void testHasName() {
        ...
        InstrumentTuning t = new InstrumentTuning(GuitarString.E2);
    ...
    public void testGetName() {
        ...
        InstrumentTuning t = new InstrumentTuning(strings);
    ...
    public void testGetCategory() {
        assertEquals(InstrumentTuning.Category.COMMON, tuning.category);
    }
    ...
    public void testFromString() {
        ...
        // Check unnamed.
        InstrumentTuning newTuning = InstrumentTuning.fromString("E2 E2 E2 E2 E2 E2");
        assertEquals("Did not return correct tuning.", new InstrumentTuning(expectedStrings), newTuning);
        assertEquals("Set name.", "EEEEEE", newTuning.getName());
        assertNull("Set category.", newTuning.category);

        // Check named and categorised.
        newTuning = InstrumentTuning.fromString("InstrumentTuning", Instrument.GUITAR, InstrumentTuning.Category.COMMON, "E2 E2 E2 E2 E2 E2");
        assertEquals("Did not return correct tuning.", new InstrumentTuning("InstrumentTuning", Instrument.GUITAR, InstrumentTuning.Category.COMMON, expectedStrings), newTuning);

        // Check invalid format.
        assertThrows("Created tuning from invalid tuning string.", IllegalArgumentException.class, ()-> InstrumentTuning.fromString("E4B4G3D3A2E2"));
    }
    ...
    public void testWithString() {
        ...
        assertTrue(Tunings.DROP_D.equivalentTo(tuning.withString(5, GuitarString.D2)));
    ...
    public void testEquals() {
        ...
        assertEquals("Same objects are not equal.", Tunings.STANDARD, tuning);

        // Check equality.
        InstrumentTuning standard = new InstrumentTuning("Standard", Instrument.GUITAR, InstrumentTuning.Category.COMMON, GuitarString.E4, GuitarString.B3, GuitarString.G3, GuitarString.D3, GuitarString.A2, GuitarString.E2);
        assertEquals("Tunings were not equal.", Tunings.STANDARD, standard);
        InstrumentTuning eadgbe = new InstrumentTuning(Instrument.GUITAR, GuitarString.E4, GuitarString.B3, GuitarString.G3, GuitarString.D3, GuitarString.A2, GuitarString.E2);
        assertNotEquals("", Tunings.STANDARD, eadgbe);
        InstrumentTuning bass = new InstrumentTuning("Standard", Instrument.BASS, InstrumentTuning.Category.COMMON, GuitarString.E4, GuitarString.B3, GuitarString.G3, GuitarString.D3, GuitarString.A2, GuitarString.E2);
